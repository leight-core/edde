...
use Edde\Api\Shared\Translation\Endpoint\EnsureEndpoint;
use Edde\Api\Shared\Translation\Endpoint\TranslationsCountEndpoint;
...
class TranslationRouterGroup extends AbstractRouterGroup {
	public function register(RouteCollectorProxyInterface $routeCollectorProxy) {
		$this->endpoints($routeCollectorProxy, [
			...
			TranslationsCountEndpoint::class,
