...
export interface I{$name}PageProps extends Omit<IPageProps, "children" | "breadcrumbProps" | "breadcrumbMobileProps" | "breadcrumbBrowserProps" | "extra" | "extraBrowser" | "extraMobile"> {
